...
<html>
    ...
    <div class ="delete">   
        <form action ="../controller/drop.php" method ="POST">
            <h3 class = "title">¿Que Comentario Quieres Eliminar?</h3>
              <p>Titulo Del Comentario</p><input type = "text" id ="jax" name="title">
              <table>
                  <td><input type="reset" value="Limpiar" class ="uno"></td><td> <input type="submit" value="Eliminar" class="uno"></td>
              </table>
        </form>     
    </div>  
    </center>
