...
<html>
    ...
    <div class ="maik">   
        <form action ="../controller/add_wish.php" method ="POST">
            <h3 class = "title">Ingresa Tu Comentario...</h3>
            <p>Titulo Del Comentario</p><input title = "Se necesita el titulo del deseo" type = "text" id ="jinx" name="title" required>
                <div><textarea name ="deseo" rows="14" cols="50"  id="area" title ="Ingresa el deseo " required ></textarea></div>
                <input type="reset" value="Limpiar" class ="uno"> <input type="submit" value="Agregar" class="uno">
        </form>     
    </div>  
    </center>
    </body>
